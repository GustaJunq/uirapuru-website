  ...
  return (
    <>
      ...
      <aside className="history-panel" data-open={open} aria-hidden={!open}>
        ...
        <div className="px-3">
          <Link href="/" onClick={onClose} className="flex h-11 items-center gap-3 rounded-xl border border-border px-3 text-sm font-medium transition-colors hover:bg-secondary">
